...
public class Email {
    ...
    static final String SenderId = "thivya1998@gmail.com";
    static final String Senderpass = "aiyaamma";
    ...
    public void newsletter(String email) {
        ...
        try {
            ...
            msg.setSubject("News Letter for this  month");
    ...
    public void enquiry(String email,String enquiry) {
        String content = enquiry;
        receiveremailID = email;
        Properties properties = System.getProperties();
        properties.put("mail.smtp.user", SenderId);
        properties.put("mail.smtp.host", emailSMTPserver);
        ...
        try {
            ...
            Session session = Session.getInstance(properties, auth);
            MimeMessage msg = new MimeMessage(session);
            msg.setSubject("Email Enquiry");
            msg.setText(content);
            msg.setFrom(new InternetAddress(receiveremailID));
            msg.addRecipients(Message.RecipientType.TO, String.valueOf(new InternetAddress(SenderId)));
            Transport.send(msg);
            System.out.println("Message Sent");
    ...
    public static class SMTP extends Authenticator {
